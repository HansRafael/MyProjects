 ...
 * item in an array and returns a single value (i.e. string, number, object, array).
...
function getRating(watchList){
  ...
  var count = 0
  var averageRating = watchList.reduce((average, filter) => {
    if(filter.Director == "Christopher Nolan"){
        count+=1;
        return average + parseFloat(filter.imdbRating);
    }
    return average;
  },0)/count;
